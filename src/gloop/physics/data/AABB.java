...
public class AABB {
	...
	public static void create(Vector3f[] points, AABB out) {
		float
	...
	public static void set(AABB out, Vector3f position, Vector3f size) { set(position.x, position.y, position.z, size.x, size.y, size.z, out); }
	public static void set(float x, float y, float z, float width, float height, float depth, AABB out) {
		out.x = x;
		out.y = y;
		out.z = z;
		out.width = width;
	...
	public static void createFromRotated(Quaternion rotation, AABB out) {
