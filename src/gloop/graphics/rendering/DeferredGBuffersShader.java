...
final class DeferredGBuffersShader extends GBufferShader {
	...
	protected void bindAttributes() {
		...
		bindAttribute("Tangent", VertexArray.VERTEX_TANGENTS_INDEX);
	}
	...
	public void setCameraUniforms(Camera camera, Matrix4f modelmatrix) {
		...
		setAlbedoMap(TextureUnit.ALBEDO_MAP);
		setNormalMap(TextureUnit.NORMAL_MAP);
		setSpecularMap(TextureUnit.SPECULAR_MAP);
		setDepthMap(TextureUnit.DEPTH_MAP);
		setEnvironmentMap(TextureUnit.ENVIRONMENT_MAP);
	}
}
