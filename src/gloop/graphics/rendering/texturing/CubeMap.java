...
public class CubeMap extends Texture {
	...
	public static final Vector3f DEFAULT_SIZE = new Vector3f(100000,100000,100000);

	private final Vector3f position = new Vector3f();
	private final Vector3f size = new Vector3f();

	public CubeMap(String name, int resolution, PixelFormat internalformat, Vector3f position, ReadableVector3f size) {
		...
		setFilteringMode(TextureFilter.Nearest);
	...
	public CubeMap(String name, String[] imagespaths, PixelComponents externalformat, PixelFormat internalformat) throws IOException {
		this(name, loadFaces(imagespaths), externalformat, internalformat, DEFAULT_POSITION, DEFAULT_SIZE);
	}
	...
	public CubeMap(String name, BufferedImage[] images, PixelComponents externalformat, PixelFormat internalformat, Vector3f position, ReadableVector3f size) {
	...
	private static BufferedImage[] loadFaces(String[] paths) throws IOException {
	...
	public void setSize(ReadableVector3f size) { this.size.set(size); }
