...
public class ImageConversion {
	...
	public static BufferedImage convertToAlpha(BufferedImage source) {
		...
		for (int y=0; y<height; y++)
			for (int x=0; x<width; x++) {
				...
				output.setRGB(x, y, alpha | (alpha << 8) | (alpha << 16) | (alpha << 24));
			}
	...
	public static void main(String args[]) {
		try {
			BufferedImage one = ImageIO.read(new File("C:/Users/Lee/workspace/Image Processing/res/original.jpg"));
			ImageIO.write(limitBits(one,4), "png", new File("C:/Users/Lee/workspace/Image Processing/res/output.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
